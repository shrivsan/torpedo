...
CSRF_TRUSTED_ORIGINS = ['http://localhost', 'http://127.0.0.1', 'http://www.example.com', 'http://example.com']
...
DATABASES = {
    'default': { 'ENGINE': 'django.db.backends.mysql', 'NAME': 'sandeep', 'USER': 'root', 'PASSWORD': 'sandeep', 'HOST': 'localhost', 'PORT': '3306', }
}
